		...
		return (
			<LinearGradient 
				...
				<View style={{ position: 'absolute', marginTop: height * 0.12, alignItems: 'center' }}>
					<MaterialIcons 
						name='store' color='white' size={fontScalling.moderateScale(50)} />

					<Text style={{ color: 'white', fontSize: fontScalling.moderateScale(43), fontWeight: 'bold' }}>AWESOME</Text>
					<Text style={{ color: '#EEEEEE', fontSize: fontScalling.moderateScale(18) }}>e-Commerce Shop Template</Text>
				</View>
				...
				<View style= {{
					...
					<View style={{ 
						...
						<Button block style={{ elevation: 0, backgroundColor: '#3e6c9d', paddingHorizontal: 15, marginBottom: 8, borderRadius: buttonBorderRadius }}>
							<FontAwesome
								name='facebook' 
								color='white' 
								size={16}
						...
						<Button block style={{ elevation: 0, backgroundColor: '#eb3f2f', paddingHorizontal: 15, borderRadius: buttonBorderRadius  }}>
							<FontAwesome
								name='google'
								color='white'
								size={16}
