		...
		return (
			<LinearGradient 
				...
				<View style={{ position: 'absolute', marginTop: height * 0.12, alignItems: 'center' }}>
					<FontAwesome 
						name='shopping-basket' color='white' size={fontScalling.moderateScale(50)} />

					<Text style={{ color: 'white', fontSize: fontScalling.moderateScale(43), fontWeight: 'bold' }}>INGE</Text>
					<Text style={{ color: '#EEEEEE', fontSize: fontScalling.moderateScale(18) }}>e-Commerce Shop UI App Template</Text>
				</View>
				...
				<View style= {{
					...
					<Text style={{ color: 'white', fontSize: 17, marginVertical: 8 }}>or connect with</Text>
