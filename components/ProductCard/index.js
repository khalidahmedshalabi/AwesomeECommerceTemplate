	...
	render() {
		...
		return (
			<View style={{ flex: 1, flexDirection: 'row', borderRadius: 1, paddingVertical: 10}}>
				<View style={{ flex: 0.6, backgroundColor: '#c8c8c8', borderTopLeftRadius:imageBorderRadius,borderBottomLeftRadius:imageBorderRadius}}>
				</View>
				<View style={{ flex: 1, backgroundColor: 'white', paddingHorizontal: 13, paddingVertical: 9, justifyContent: 'center' ,borderTopRightRadius:imageBorderRadius,borderBottomRightRadius:imageBorderRadius}}>
